...
const InProgressTask = ({setError,tasks,setIsModalVisible,setTaskMessage})=>{
    ...
    >
        <NotItContainer 
            ...
            <NotitFlex alignment="center" bgColor="#F270AF" margin="0 1.5rem 0 0">
                <TextHolder text="InProgress"  size="11px" top="0"/>
            </NotitFlex>
        ...
        {
            tasks.map(({message,id,taskType,updatedAt})=>(
            <NotItContainer
                alignment="row" 
                alignmentX="flex-start" 
