...
//TO-DO
//Remember to look into implementing fetchMore for pagination or lazy loading

const NewTask = ({setError,tasks,setIsModalVisible,setTaskMessage})=>{
    ...
    >
        <NotItContainer 
            ...
            <NotitFlex alignment="center" bgColor="#FF8D8D" margin="0 1.5rem 0 0">
                <TextHolder text="New"  size="11px" top="0"/>
            </NotitFlex>
